...
keymap.set("n", "<leader>a", function() harpoon:list():add()
end)
keymap.set("n", "<leader><leader>", function() harpoon.ui:toggle_quick_menu(harpoon:list())
end)
keymap.set("n", "<leader>1", function() harpoon:list():select(1)
end)
keymap.set("n", "<leader>2", function() harpoon:list():select(2)
end)
keymap.set("n", "<leader>3", function() harpoon:list():select(3)
end)
keymap.set("n", "<leader>4", function() harpoon:list():select(4)
end)

-- Toggle previous & next buffers stored within Harpoon list
keymap.set("n", "<leader>i", function() harpoon:list():prev()
end)
keymap.set("n", "<leader>o", function() harpoon:list():next()
end)
...
keymap.set("n", "<leader>gd", "<cmd>Lspsaga finder<CR>", { desc = "[G]oto de[F]inition" }) -- show definition, references
...
keymap.set("n", "<leader>db", "<cmd>Lspsaga show_buf_diagnostics<CR>", { desc = "Show line [D]iagnostics" }) -- show  diagnostics for line
